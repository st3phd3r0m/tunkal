 ...
 */
final class Version20201003135203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE links (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, hyperlink VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT NULL, position VARCHAR(255) DEFAULT NULL, position_order INT DEFAULT NULL, alt VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, is_active TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE posts (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, meta_title VARCHAR(255) NOT NULL, meta_description LONGTEXT NOT NULL, content LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', meta_keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', created_at DATETIME NOT NULL, is_past_concert TINYINT(1) NOT NULL, slug VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_885DBAFA989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE shows (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, meta_description LONGTEXT NOT NULL, meta_title VARCHAR(255) NOT NULL, expected_at DATETIME NOT NULL, image VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, description LONGTEXT NOT NULL, meta_keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6C3BF144989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
