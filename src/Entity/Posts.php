...
class Posts
{
    ...
    public function getIsPastConcert(): ?bool
    {
        return $this->is_past_concert;
    }

    public function setIsPastConcert(bool $is_past_concert): self
    {
        $this->is_past_concert = $is_past_concert;
